...
const createCourse = async (req, res) => {
    ...
    try {
        const [result] = await pool.query('INSERT INTO course (course_code, course_name, user_id, dept_id) VALUES (?, ?, ?, ?)',
...
const updateCourse = async (req, res) => {
    ...
    try {
        const [result] = await pool.query('UPDATE course SET course_code = ?, course_name = ?, user_id = ?, dept_id WHERE course_id = ?',
