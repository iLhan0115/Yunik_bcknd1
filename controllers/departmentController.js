...
const getDepartmentById = async (req, res) => {
    ...
    try {
      const [rows] = await pool.query('SELECT * FROM users WHERE dept_id = ?', [id]);
...
const createDepartment = async (req, res) => {
    ...
    try {
        const [result] = await pool.query('INSERT INTO departments (dept_code, dept_name, user_id) VALUES (?, ?, ?)',
